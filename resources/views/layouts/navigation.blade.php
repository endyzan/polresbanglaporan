            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('assets/img/logos/logo_polres.png') }}" class="block h-9 w-auto" alt="Logo">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('admin.spktkegiatan.index')">
                                {{ __('SPKT') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('admin.skcksarana.index')">
                                {{ __('SKCK') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                    ...
                    <!-- Polsek -->
                    <x-nav-link :href="route('admin.polsek.index')" :active="request()->routeIs('admin.polsek.*')">
                        {{ __('Polsek') }}
                    </x-nav-link>
                </div>
            </div>
